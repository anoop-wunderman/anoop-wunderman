...
COPY projects/equipment-management/src /workspace/projects/equipment-management/src
...
COPY tsconfig.server.json server.ts kafka.ts server.kafka.ts server.mongo.ts server.aws.ts /workspace/
